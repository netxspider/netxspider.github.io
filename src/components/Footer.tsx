...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-black via-gray-900/50 to-black border-t border-white/10 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Building innovative solutions with AI/ML, exploring the frontiers of technology, and creating impactful digital experiences.
            </p>
          </motion.div>
            ...
            <nav className="flex flex-col space-y-2">
              {footerLinks.map((link) => (
                <a
                  ...
                  className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm group flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="group relative w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:border-cyan-400/50 transition-all duration-300 hover:bg-white/10"
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-xl bg-cyan-400/20 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300"></div>
                </a>
              ))}
            </div>
            <a
